...
namespace School
{
    ...
    public class Student
    {
        ...
        {
            if (this.major is null) this.major = new List<Major>();
            this.major.Add(new Major(code, name));
        }

        public void delectMajor(int code, String name)
        {
    ...
    public class Program
    {
        ...
        public static List<Teacher> setTeacherList(List<Teacher> teacherList)
        {
